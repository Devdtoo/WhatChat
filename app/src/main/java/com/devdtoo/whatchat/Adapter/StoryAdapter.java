...
import com.devdtoo.whatchat.Add_Story_Activity;
import com.devdtoo.whatchat.Model.Story;
import com.devdtoo.whatchat.Model.User;
import com.devdtoo.whatchat.R;
import com.devdtoo.whatchat.StoryActivity;
...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (holder.getAdapterPosition() == 0){
                    myStory(holder.addstory_text, holder.story_photo, true);
                } else {
                    // TODO: go to story
    ...
    @Override
    public int getItemCount() { return mStory.size(); }
    //..............................................................................................

    private void userInfo(final ViewHolder holder, String userid, final int position) {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (click) {
                    if (count > 0) {
                        ...
                        alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "See Story",
    ...
    //    ViewHolder that Binds Views to layout file................................................
